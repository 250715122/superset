...
export interface CandlestickFormData extends QueryFormData {
  currencyFormat?: Currency;
  metricOpen: QueryFormMetric;
  metricClose: QueryFormMetric;
  metricLow: QueryFormMetric;
  metricHigh: QueryFormMetric;
